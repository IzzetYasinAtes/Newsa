...
const corporateLinks = [
  ...
  { name: 'İletişim', href: '/sayfa/iletisim' },
  { name: 'Gizlilik Politikası', href: '/sayfa/gizlilik-politikasi' },
  { name: 'Kullanım Koşulları', href: '/sayfa/kullanim-kosullari' },
]
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-slate-400">
              ...
              Güncel haberler, analizler ve derinlemesine içeriklerle
              her gün yanınızda.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-slate-400">
              <li>
                <a href="mailto:info@newsa.com" className="transition-colors hover:text-white">
                  info@newsa.com
                </a>
              </li>
              <li>
                <a href="tel:+902125550000" className="transition-colors hover:text-white">
                  +90 212 555 00 00
                </a>
              </li>
            </ul>
